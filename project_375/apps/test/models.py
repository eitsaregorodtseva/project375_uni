...
class Question(models.Model):
    ...
    title = models.CharField(max_length=500)
    question_type = models.CharField(max_length=50, choices=QUESTION_TYPE_CHOICES, default='')
...
class Poll(models.Model):
    ...
    def __str__(self):
        return f'[ user id: {self.user}, question id: {self.question.id}] id: {self.id}. ответ: {self.user_answer}'
...
class CompletedPoll(models.Model):
    ...
    def __str__(self):
        return f'user id: {self.user}, questionnaire id: {self.questionnaire.id}, опрос пройден: {self.completion_date}'
